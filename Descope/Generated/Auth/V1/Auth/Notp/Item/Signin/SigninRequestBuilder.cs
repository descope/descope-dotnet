...
using System;
namespace Descope.Auth.V1.Auth.Notp.Item.Signin
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Descope.Auth.V1.Auth.Notp.Item.Signin.SigninRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SigninRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/auth/notp/{provider}/signin", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Descope.Auth.V1.Auth.Notp.Item.Signin.SigninRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SigninRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/auth/notp/{provider}/signin", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Descope.Auth.V1.Auth.Notp.Item.Signin.SigninRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Descope.Auth.V1.Auth.Notp.Item.Signin.SigninRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Descope.Auth.V1.Auth.Notp.Item.Signin.SigninRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
