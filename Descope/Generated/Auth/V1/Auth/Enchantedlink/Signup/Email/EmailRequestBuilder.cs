...
using System;
namespace Descope.Auth.V1.Auth.Enchantedlink.Signup.Email
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\auth\enchantedlink\signup\email
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class EmailRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Descope.Auth.V1.Auth.Enchantedlink.Signup.Email.EmailRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmailRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/auth/enchantedlink/signup/email", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Descope.Auth.V1.Auth.Enchantedlink.Signup.Email.EmailRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EmailRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/auth/enchantedlink/signup/email", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Descope.Auth.V1.Auth.Enchantedlink.Signup.Email.EmailRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Descope.Auth.V1.Auth.Enchantedlink.Signup.Email.EmailRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Descope.Auth.V1.Auth.Enchantedlink.Signup.Email.EmailRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
