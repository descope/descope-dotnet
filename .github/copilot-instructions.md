...
- One documented exception: a targeted endpoint addition (`make add-mgmt` / `make add-auth`) merges a single navigation property into one existing request builder. See "Targeted Endpoint Additions" in `README-maintainer.md`
...
- Never edit generated files directly, except the single navigation-property merge of a targeted endpoint addition
